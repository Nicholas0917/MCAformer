...
parser.add_argument('--model', type=str, default='MCAformer', help='model name,')
...
if args.is_training:
    ...
    print('average mse:{0:.4f}±{1:.4f}, mae:{2:.4f}±{3:.4f}'.format(np.mean(mses), np.std(mses), np.mean(maes),
                                                                    np.std(maes)))
else:
    ii = 0
