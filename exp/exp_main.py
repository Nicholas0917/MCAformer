...
from models import Informer, Autoformer, Transformer, DLinear, Linear, NLinear, FEDformer, MCAformer
...
class Exp_Main(Exp_Basic):
    ...
    def _build_model(self):
        ...
        model_dict = {
            ...
            'Linear': Linear,
            'RetNet': RetNet,
            'RetNet_Multi': RetNet_Multi,
            'MCAformer': MCAformer,
            'RetNet_Multi_SE': RetNet_Multi_SE,
            'RetNet_Multi_FNN': RetNet_Multi_FNN,
            'RetNet_Multi_WithoutChannelMixing': RetNet_Multi_WithoutChannelMixing,
        }
    ...
    def train(self, setting):
        ...
        for epoch in range(self.args.train_epochs + self.station_pretrain_epoch):
            ...
            # nni.report_intermediate_result({'test_loss': test_loss})
    ...
    def test(self, setting, test=0):
        ...
        f.write('\n')
        f.close()
        # nni.report_final_result({'mae': mae, 'mse': mse})
